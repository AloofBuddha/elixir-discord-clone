defmodule DiscordWeb.UserAuthTest do
  use DiscordWeb.ConnCase, async: true

  alias Discord.Accounts
  alias Discord.Accounts.Scope
  alias DiscordWeb.UserAuth

  import Discord.AccountsFixtures

  @remember_me_cookie "_discord_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DiscordWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
